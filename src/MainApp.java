...
public class MainApp {
    ...
    static ArrayList<Fruit> list = new ArrayList<>();
    ...
    private static void goShopping(ArrayList<Fruit> listFruit) {
        while (true) {
            ...
            lo.add(new Order(fm.getFruitByItem(item).getFruitId(), fm.getFruitByItem(item).getFruitName(), fm.getFruitByItem(item).getQuantity(), fm.getFruitByItem(item).getPrice()));
